...
from project.eval_dpfm import eval_net_unsup
...
if __name__ == '__main__':
    ...
    eval_net_unsup(cfg, f"{args.path}/project/data/shrec_pretrained_model/shrec_cuts.pth", f"{args.path}/data/test_unsup.pt")
