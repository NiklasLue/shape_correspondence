...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, help='relative path to config file', default="project/config/shrec16_cuts.yaml", dest="config_path")
    ...
    eval_net(cfg, f"{args.path}/project/data/shrec_pretrained_model/shrec_cuts.pth", f"{args.path}/data/test.pt", mode="CFM")
